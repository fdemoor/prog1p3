...
\paragraph{Throwing projectiles} Apart from the instant kill of the Hungry Ants, all attacks are projectiles thrown at the enemy. To do that, a target is found by going through the entrances (or exits) of the tunnel, starting by the Place of the insect. Once the ant knows there is a target, a new Projectile is created with a position, a target, and the damages it should inflict on hit.
...
\begin{tabular}{c p{12cm}}
	\raisebox{-.5\height}{\includegraphics[scale=0.6]{waveDiagram.png}} % I don't think it is useful, doens't give any information
	% No, but it breaks the queasy text, and is still nice
